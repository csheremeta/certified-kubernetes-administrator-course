...
- Taints and Tolerations do not guarantee that the pods will only prefer these nodes; in this case, the red nodes may end up on one of the other nodes that do not have a taint or toleration set.
